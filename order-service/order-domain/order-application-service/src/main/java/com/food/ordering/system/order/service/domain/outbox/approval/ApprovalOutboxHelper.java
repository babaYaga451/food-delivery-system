...
public class ApprovalOutboxHelper {
  ...
  public ApprovalOutboxHelper(
      @Qualifier("approvalOutboxRepositoryImpl") ApprovalOutboxRepository approvalOutboxRepository,
  ...
  public Optional<List<OrderApprovalOutboxMessage>> getApprovalOutboxMessageByOutBoxStatusAndSagaStatus(
    ...
    return approvalOutboxRepository.findByTypeAndOutboxStatusAndSagaStatue(
        ORDER_SAGA_NAME,
        outboxStatus,
        sagaStatus);
  }
  ...
  private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
    try {
      ...
      log.error("Couldn't create OrderApprovalEventPayload object for id: {}",
          orderApprovalEventPayload.getOrderId(), e);
      throw new OrderDomainException("Couldn't create OrderApprovalEventPayload object for id: "+
          orderApprovalEventPayload.getOrderId(), e);
    }
  }
}
